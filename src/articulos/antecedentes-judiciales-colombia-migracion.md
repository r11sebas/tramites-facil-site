...
readTime: "9 min"
---
Varios trámites migratorios (visas de trabajo, residencia permanente,
algunos permisos de estudio prolongados) exigen certificados de
antecedentes para verificar que no tienes historial judicial relevante.
Colombia tiene varios certificados distintos, no todos son el mismo
documento, y la vigencia que exige la entidad migratoria casi nunca
coincide con la vigencia oficial del certificado — esa confusión es la
causa más común de que alguien tenga que repetir el trámite.

## Certificados más comunes en Colombia
...
- **Certificado de antecedentes judiciales de la Policía Nacional**: el más
  ...
  Este es el que casi siempre te van a pedir para visa de EEUU o Canadá.
...
conviene confirmar la lista exacta antes de empezar a tramitarlos.
...
La mayoría de estos certificados se pueden generar **en línea, de forma
gratuita**, directamente en los portales oficiales de cada entidad (Policía
Nacional, Procuraduría, Contraloría), sin necesidad de intermediarios ni
pago:

1. Ingresa al portal oficial correspondiente (Policía Nacional para el más
   común).
2. Ingresa tu número de cédula y los datos que solicite el sistema.
3. El sistema genera el certificado en formato PDF, normalmente al
   instante.
4. Descarga y guarda el documento — anota la fecha de generación para
   calcular su vigencia frente al trámite que estás haciendo.

## Traducción y apostilla

Si el trámite migratorio exige presentar el certificado en inglés, vas a
necesitar una **traducción oficial o certificada** (ver nuestra guía sobre
[traducción oficial de documentos](/articulos/traduccion-oficial-documentos-para-visa/)),
y en muchos casos también la **apostilla** del documento original antes de
traducirlo (ver nuestra guía de
[apostilla](/articulos/que-es-la-apostilla-como-tramitarla-colombia/) para
el costo y tiempo exactos de ese trámite).

## Si tienes antecedentes registrados

Tener un antecedente no significa automáticamente una negación, pero sí
puede requerir documentación adicional o una evaluación más detallada por
parte de la entidad migratoria. En estos casos, conviene ser completamente
transparente en la solicitud y, si el caso es complejo, consultar con un
abogado de inmigración antes de aplicar.
...
- **No verificar cuál de los tres certificados exige tu trámite
  ...
  pero es tiempo que no necesitabas invertir.
- **Traducir antes de apostillar**, cuando el orden correcto para la
  mayoría de trámites es apostillar primero.

## Preguntas frecuentes

**¿El certificado de antecedentes tiene algún costo?**
No, los tres certificados (Policía, Procuraduría, Contraloría) se generan
gratis en los portales oficiales.

**¿Puedo generarlo desde fuera de Colombia?**
Sí, los tres portales son en línea y no requieren presencia física en
Colombia.

**¿Qué pasa si mi certificado vence antes de la entrevista?**
Genera uno nuevo — es gratis y toma minutos, así que no hay razón para
presentar uno vencido según el criterio del consulado.
